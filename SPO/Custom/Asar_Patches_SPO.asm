...
; Note: Put your custom routine/data macros, references to them, and defines in this file from within the SPO_InsertIntegratedPatches and SPO_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro SPO_InsertIntegratedPatches()
...
macro SPO_ApplyPatchesPostAssembly()
...
macro SPO_HandleDefaultPatches()
