...
set Input1=
set ROMName=
set ROMName0=SPO_U.sfc
set ROMName1=SPO_J.sfc
set ROMName2=SPO_E.sfc
set MemMap=lorom
...
:Start
echo Place a headerless SPO ROM with one of the following names in this folder, then type the number representing what ROM to extract from.
echo 0 = "%ROMName0%" (USA)
echo 1 = "%ROMName1%" (Japan)
echo 2 = "%ROMName2%" (PAL)
...
if %PointerSet% equ 42 goto :MoveBRR
goto :MoveNothing
